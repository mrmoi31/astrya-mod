...
public class TestScreen extends AbstractContainerScreen<TestMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("astrya:textures/screens/test.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("gui.astrya.test.label_backpack"), 5, 6, -12829636);
	}
