...
public class Mob1Renderer extends HumanoidMobRenderer<Mob1Entity, HumanoidModel<Mob1Entity>> {
	...
	public ResourceLocation getTextureLocation(Mob1Entity entity) {
		return new ResourceLocation("astrya:textures/entities/zombie_king_freeze.png");
	}
}
