...
public class SteelPickaxeQuandLeBlocEstDetruitAvecLoutilProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		boolean removeBlock = false;
		if (AstryaModItems.STEEL_PICKAXE.get().isCorrectToolForDrops((world.getBlockState(new BlockPos(x, y, z)))) == true) {
