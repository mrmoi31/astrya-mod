...
public class ThunderBowItem extends Item {
	public ThunderBowItem() {
		super(new Item.Properties().tab(AstryaModTabs.TAB_ASTRYA).durability(100));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					ThunderBowEntity entityarrow = ThunderBowEntity.shoot(world, entity, world.getRandom(), 1f, 7, 3);
