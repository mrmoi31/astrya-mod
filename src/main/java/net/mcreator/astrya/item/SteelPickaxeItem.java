...
import net.mcreator.astrya.procedures.SteelPickaxeQuandLeBlocEstDetruitAvecLoutilProcedure;
...
public class SteelPickaxeItem extends PickaxeItem {
	...
	public boolean mineBlock(ItemStack itemstack, Level world, BlockState blockstate, BlockPos pos, LivingEntity entity) {
		...
		SteelPickaxeQuandLeBlocEstDetruitAvecLoutilProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
		return retval;
	}
}
