...
public class AstryBiomeTrunkDecorator extends TrunkVineDecorator {
	public static final AstryBiomeTrunkDecorator INSTANCE = new AstryBiomeTrunkDecorator();
	public static com.mojang.serialization.Codec<AstryBiomeTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("astry_biome_tree_trunk_decorator");
