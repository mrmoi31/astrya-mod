...
package net.mcreator.astrya.world.dimension;
...
public class AstryWorldDimension {
	...
	public static class Fixers {
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("astrya:astry_world"), customEffect));
		}
	}
}
