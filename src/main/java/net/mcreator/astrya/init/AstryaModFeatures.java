...
import net.mcreator.astrya.world.features.ores.SaphirOreFeature;
import net.mcreator.astrya.world.features.ores.RubisOreFeature;
import net.mcreator.astrya.world.features.ores.AstryaLeavesFeature;
...
public class AstryaModFeatures {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, AstryaMod.MODID);
	...
	public static final RegistryObject<Feature<?>> ASTRYA_LEAVES = register("astrya_leaves", AstryaLeavesFeature::feature,
			new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_ORES, AstryaLeavesFeature.GENERATE_BIOMES, AstryaLeavesFeature::placedFeature));
